...
class PendulumWithInputAndDisturbcontrol(asys.SymbolicContinuousSystem):
    r"""
    ...
    def __init__(self, g=9.81, l=1.0, beta=0.0):
        self.name = "pendulum_withD_onfullstate"
        ...
        print("pendulum with D on full state: " + str(self.input_set_low) + " : " + str(self.input_set_high))
        ...
        super(PendulumWithInputAndDisturbcontrol, self).__init__(
